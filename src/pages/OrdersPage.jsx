  ...
  const handlePayRemaining = async (order) => {
    try {
      ...
      // Backend should return Razorpay order details for the remaining amount
      const res = await axios.post(
        URLS.remainingAmount(order.id),
        { remainingAmount: order.remainingAmount },   // send remaining amount
      ...
      if (!razorpayOrderId || !amount || !key) {
        throw new Error("Invalid Razorpay details");
      }
      ...
      const options = {
        ...
        handler: function (response) {
          toast({
            ...
            description: "Remaining balance has been paid.",
          });
      ...
      toast({
        ...
        description: "Could not process the remaining payment",
        variant: "destructive",
      });
    }
  };
